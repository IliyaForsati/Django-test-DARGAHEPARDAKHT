...
(function($) { // hide the namespace
    ...
    $.keypad.regionalOptions.fa = {
        buttonText: "...",
        buttonStatus: "باز کردن صفحه کلید",
        closeText: "بستن",
        closeStatus: "بستن صفحه کلید",
        clearText: "بازنویسی",
        clearStatus: "بازنویسی کل متن",
        backText: " تصحیح",
        backStatus: "تصحیح کاراکتر قبلی",
        shiftText: "شیفت",
        shiftStatus: "تغییر حروف بزرگ / کوچک",
        spacebarText: "&nbsp;",
        spacebarStatus: "",
        enterText: "ورود",
        enterStatus: "ورود اطلاعات",
        tabText: "تب",
        tabStatus: "",
        ...
        isRTL: false,
        layout: ["123" + $.keypad.SPACE, "456" + $.keypad.SPACE, "789" + $.keypad.SPACE, $.keypad.CLEAR + "0" + $.keypad.BACK + $.keypad.SPACE, $.keypad.CLOSE]
    };
